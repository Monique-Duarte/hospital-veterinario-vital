...
const equipe: MembroEquipe[] = [
  ...
  { name: "Dra. Bruna Micheleto", role: "Clinica Médica | CRMV-SC 15204", imageSrc: "/equipe-1.jpg", unit: "Laguna"},
        ...
        <div className="container px-4 md:px-6">
          <div className="text-center space-y-4 mb-12">
            ...
            <p className="max-w-[700px] mx-auto text-muted-foreground md:text-xl">
              Profissionais apaixonados e dedicados ao bem-estar do seu pet, em
              cada unidade.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
            {videos.map((video) => (
              <div key={video.title} onClick={() => handleOpenVideo(video)} className="relative group cursor-pointer rounded-lg overflow-hidden shadow-lg transition-shadow hover:shadow-xl">
          ...
          {selectedVideo?.videoSrc && (
            <div className="flex flex-col items-center gap-4">
              ...
              <div className="relative h-[90vh] sm:h-[80vh] aspect-[9/16] rounded-lg overflow-hidden shadow-lg">
                ...
                {/* O Header do Dialog (para acessibilidade) também fica aqui */}
